...
<template>
  <div>
    ...
    <div>
      <input v-model="newTask.label" aria-label="Task label" type="text" placeholder="Añadir tarea" />
      <select v-model="newTask.type" aria-label="Task type">
    ...
    <select v-model="newTask.priority" aria-label="Task priority">
    ...
    <ul>
      <li v-for="(task, index) in filteredTasks" :key="index">
        <input type="checkbox" v-model="task.isComplete" aria-label="Mark task complete" />
