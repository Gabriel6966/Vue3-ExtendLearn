...
<template>
  <div>
    ...
    <div>
      ...
      <button @click="listFilter = 'complete'" :aria-pressed="listFilter === 'complete'">
        Completadas
      </button>
      <button @click="listFilter = 'incomplete'" :aria-pressed="listFilter === 'incomplete'">
        Incompletas
      </button>
    </div>
    ...
    <ul>
      <li v-for="(task, index) in filteredTasks" :key="index">
        <input
          ...
          :aria-label="'Marcar ' + task.label + ' como completada'"
        />
