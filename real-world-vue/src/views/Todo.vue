...
<template>
  <div>
    ...
    <div>
      <input v-model="newTask.label" type="text" placeholder="Añadir tarea" aria-label="New task name" />
      <select v-model="newTask.type" aria-label="New task type">
    ...
    <select v-model="newTask.priority" aria-label="New task priority">
