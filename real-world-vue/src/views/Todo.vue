...
<template>
  <div>
    ...
    <div>
      <input aria-label="Añadir tarea" v-model="newTask.label" type="text" placeholder="Añadir tarea" />
    ...
    <ul>
      <li v-for="(task, index) in filteredTasks" :key="index">
        <input :aria-label="'Marcar ' + task.label + ' como completada'" type="checkbox" v-model="task.isComplete" />
